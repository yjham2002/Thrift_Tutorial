...
public class UserBean {
	...
	public void setTimeLineNew(String timeLineNew)
	{
		this.timeLineNew = timeLineNew;
	}
	...
	public int getCoordiCount() {
		return coordiCount;
	}
	public void setCoordiCount(int coordiCount) {
		this.coordiCount = coordiCount;
	}
